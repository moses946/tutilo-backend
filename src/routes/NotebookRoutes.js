...
import { handleConceptChatCreate, handleConceptDetail, handleConceptList, handleLastViewedUpdate, handleConceptMapRetrieval, handleMaterialDownload, handleNotebookCreation, handleNotebookDeletion, handleNotebookEditFetch, handleNotebookFetch, handleNotebookRead, handleNotebookUpdate, handleUserProgressUpdate, handleChunkFetch, handleNotebookStatus, handleNotebookProcessing, handleAudioGeneration, handleGenerateNotebookQuiz} from '../controllers/NotebookController.js';
...
notebookRouter.post('/:id/quiz/comprehensive', handleGenerateNotebookQuiz);
...
notebookRouter.post('/audio', handleAudioGeneration);
notebookRouter.post('/lastViewed', handleLastViewedUpdate);
